  ...
  fields: {
    style: {
      ...
      options: [
        ...
        { value: "archival-collage", label: "Muted archival collage", fragment: "Render as a calm, muted, atmospheric photo-collage in which every element looks cleanly composited together into a single, unified image — as if separate photographic elements have all been layered and carefully colour-matched together in Photoshop. Grade the whole picture to a soft, near-monochrome greyscale with a faint warm undertone, gently and evenly desaturated, so every element shares exactly the same muted tone, light, and consistent exposure. Keep all elements clean, intact, and well-kept: do NOT make anything look old, aged, damaged, dilapidated, torn, ripped, distressed, dusty, stained, or bleached, and do not show ragged or cut edges — blend the composited elements together smoothly and seamlessly with no visible seams. Give it a fine, subtle, even film-photographic grain, delicate and consistent across the whole image and never coarse, heavy, or noisy, for a gentle analogue quality. Keep the focus gently soft and the mood tranquil, restrained, and atmospheric. Any vignette must be almost imperceptible — barely noticeable at most. The overall feel should be a serene, contemporary architectural mood image — quiet, tonal, and evenly muted — not a distressed, damaged, or vintage-looking photograph." },
