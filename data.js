  ...
  fields: {
    style: {
      ...
      options: [
        ...
        { value: "archival-collage", label: "Muted archival collage", fragment: "Render as a muted, atmospheric archival collage — evocative and mood-driven, not photographic. Assemble it from old, collaged photographic fragments that look pre-digital and completely unretouched, as if torn from aged prints or magazines long before any Photoshop or editing: faded, imperfect, dust-flecked, and softly out of focus. Composite the building's elements into the scene loosely and by hand, letting the cut edges, seams, and layering stay clearly visible for a raw, analogue, collaged feel. Grade the whole picture to a near-monochrome greyscale with a faint warm sepia undertone — heavily desaturated and softly bleached — held to a single consistent tonal range so every fragment unifies. Keep it hazy, soft-focus, and dreamlike, prioritising light, mood, and spatial atmosphere far above sharpness, detail, or material accuracy. Lay a heavy film grain across the entire image and add a soft, dark vignette around the edges, so it reads like a scanned, time-worn photographic print or an early-stage atmospheric mood board rather than any kind of render." },
